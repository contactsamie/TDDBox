...
let description = "Learning TDD using the TDD Box"

// List of author names (for NuGet package)
let authors = [ "samuel" ]

// Tags for your project (for NuGet package)
let tags = "tdd testing unittesting"

// File system information
let solutionFile  = "TDDBox.sln"
...
let gitOwner = "tdd"
let gitHome = sprintf "%s/%s" "github.com/testdrivendevelopment/tddbox" gitOwner

// The name of the project on GitHub
let gitName = "tddbox"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/tdd"
